...
public class FinalDemo {
    ...
    void noOneShouldOverrideIt(){
        System.out.println("This method should never be overriden otherwise it might break the code base");
    }
}

class Nelson extends FinalDemo{
    //void noOneShouldOverrideIt{// we cant override this method as it is declared as final
